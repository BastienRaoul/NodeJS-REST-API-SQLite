...
class ActiviteDao {
    ...
    findByHandicap(accessibilite_handicapes_a_mobilite_reduite){
        const sqlRequest = "select activite.activite_code, activite.activite_libelle, " +
            "equipement.numero_de_la_fiche_equipement," +
            ...
            "inner join equipement on equipement.numero_de_la_fiche_equipement = activite.numero_de_la_fiche_equipement " +
            "inner join installation on installation.numero_de_l_installation = equipement.numero_de_l_installation "+
            "where installation.accessibilite_handicapes_a_mobilite_reduite = $accessibilite_handicapes_a_mobilite_reduite";

        const sqlParams = {
            //pas sur de ça : $codePostal: codePostal
            $accessibilite_handicapes_a_mobilite_reduite: accessibilite_handicapes_a_mobilite_reduite
         };
